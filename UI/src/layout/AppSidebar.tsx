...
import { RenderIcon } from "../components/common/IconRenderer";
              ...
              >
                {RenderIcon(nav.icon, {
                  className:
                    ...
                    typeof nav.icon.props === 'object' &&
                    nav.icon.props !== null &&
                    'className' in nav.icon.props
                      ? String((nav.icon.props as { className?: string }).className ?? '')
                      : '',
                })}
              </span>
