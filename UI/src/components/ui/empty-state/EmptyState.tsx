...
export default function EmptyState({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-200 bg-gray-50/50 px-6 py-12 text-center dark:border-gray-800 dark:bg-gray-900/40 ${className}`}
      role="status"
    >
      {icon && (
