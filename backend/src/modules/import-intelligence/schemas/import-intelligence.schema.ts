...
export const BankLancamentoSchema = new Schema(
  {
    ...
    vinculo_tipo: { type: String, enum: ['nota', 'frete'], sparse: true, index: true },
    frete_titulo_id: { type: Schema.Types.ObjectId, ref: 'FreteTitulo', index: true, sparse: true },
    candidatas_frete_titulo_ids: [{ type: Schema.Types.ObjectId, ref: 'FreteTitulo' }],
    tipo_transacao: { type: String },
