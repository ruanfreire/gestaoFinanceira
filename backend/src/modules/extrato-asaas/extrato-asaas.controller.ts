...
@Controller('extrato-asaas')
export class ExtratoAsaasController {
  constructor(private readonly extratoService: ExtratoAsaasService) {}
  ...
  async exportacaoFluxoCaixa(
    ...
    @Query('banco_label') banco_label?: string,
  ) {
